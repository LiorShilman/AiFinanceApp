...
export class AppComponent implements AfterViewInit, OnDestroy, OnInit {
  ...
  async saveEditedMessage() {
    ...
    try {
      const response = await lastValueFrom(this.http.post<any>('http://shilmanlior2608.ddns.net:15000/api/chat', {
  ...
  private async saveConversationToServer(): Promise<void> {
    ...
    return this.http.put<any>(`http://shilmanlior2608.ddns.net:15000/api/conversations/${this.sessionId}/save`, payload).toPromise();
  }
  ...
  autoSaveConversation() {
    ...
    this.http.post<any>('http://shilmanlior2608.ddns.net:15000/api/conversations/save', payload).subscribe({
  ...
  async loadConversations() {
    try {
      this.loading = true;
      const response = await this.http.get<any>('http://shilmanlior2608.ddns.net:15000/api/conversations').toPromise();
  ...
  try {
    ...
    const response = await this.http.get<any>(`http://shilmanlior2608.ddns.net:15000/api/conversations/${sessionId}`).toPromise();
  ...
  */
  ...
  async getServerPerformanceStats() {
    try {
      ...
      const response = await this.http.get<any>('http://shilmanlior2608.ddns.net:15000/api/performance').toPromise();
